...
v3 =v1 +v2
Para compilar usar (-lrt: real time library):g++ -O2 SumaVectores.Cpp -o SumaVectores.Cpp -lrt
...
using namespace std;
#include<time.h>
// biblioteca donde se encuentra la función clock_gettime()
//#define COUT_ALL
// comentar para quitar el cout ...
...
#ifdef VECTOR_DYNAMIC
delete [] v1;
// libera el espacio reservado para v1
delete [] v2;
